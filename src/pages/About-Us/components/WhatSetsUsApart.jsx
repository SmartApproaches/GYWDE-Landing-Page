...
import { EllipseUp, EllipseDown, tdesign_money, fluent_diversity_20_filled,  ic_baseline_gpp_good, mdi_arm_flex_outline} from "../constants/images";
    ...
    <section className="relative w-full min-h-[900px] py-16 md:py-24 lg:py-32 overflow-hidden bg-[#E9F7FC]">
      ...
      <div className="relative max-w-[1300px] mx-auto flex flex-col lg:flex-row items-start gap-10 px-4 md:px-8 lg:left-[-90px] lg:top-[-150px]">
        ...
        <div
          className="
            w-full lg:w-[600px] 
            grid grid-cols-2 gap-6   /* CHANGED → small screens now 2 cols instead of 1 */
            lg:gap-x-[60px] lg:gap-y-[40px] relative
          "
        >
          {/* Flexible */}
          <div
          ...
          >
            ...
            <h3 className="font-semibold text-base md:text-md">Flexible</h3>
            <p className="text-sm md:text-[15px] text-slate-700 leading-relaxed">
              Our platform adapts to your schedule and requirements, allowing
              you to find the right service provider when and where you need
              them.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white">
            ...
            <p className="text-sm md:text-[15px] text-slate-700 leading-relaxed">
              With secure payment options and verified service providers, you
              can have peace of mind every step of the way when ordering a
              service.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white">
            ...
            <h3 className="font-semibold text-base md:text-md">Affordable</h3>
            <p className="text-sm md:text-[15px] text-slate-700 leading-relaxed">
              We ensure that you get access to a wide range of services that fit
          ...
          >
            ...
            <h3 className="font-semibold text-base md:text-md">All-in-one</h3>
            <p className="text-sm md:text-[15px] text-slate-700 leading-relaxed">
              We connect you with trusted professionals across various
              categories, making it easier for you to get things done
              effortlessly.
            </p>
          </div>
        </div>
