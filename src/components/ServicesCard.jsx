...
//   { id: 1, image: Services, title: "IT and Digital Services", category: "technology" },
//   { id: 2, image: Agriculture, title: "Agriculture", category: "farming" },
//   { id: 3, image: Entertainment, title: "Event and Entertainment", category: "events" },
//   { id: 4, image: Beauty, title: "Beauty Services", category: "personal care" },
//   { id: 5, image: Transport, title: "Transport and Logistics", category: "logistics" },
//   { id: 6, image: RepairAndMaintenance, title: "Repair and Maintenance", category: "maintenance" },
//   { id: 7, image: Creative, title: "Creative and Design", category: "design" },
//   { id: 8, image: Consulting, title: "Consulting Services", category: "consulting" },
//   { id: 9, image: Education, title: "Education Services", category: "education" },
//   { id: 10, image: Cleaning, title: "Cleaning Services", category: "home care" },
//   { id: 11, image: Photography, title: "Photography and Video", category: "media" },
//   { id: 12, image: Pet, title: "Pet Services", category: "pet care" },
//   { id: 13, image: Manufacturing, title: "Manufacturing Services", category: "industrial" },
//   { id: 14, image: Property, title: "Property Services", category: "real estate" },
...
//   // Compute categories including 'all'
...
//   // Filter services based on title/category and selectedCategory
...
//     const matchesSelected = selectedCategory && selectedCategory !== 'all'
...
//         {/* Filter button toggles category dropdown */}
...
//                 <div
//                   key={cat}
//                   className={`px-4 py-2 cursor-pointer hover:bg-gray-100 ${selectedCategory === cat ? 'font-bold' : ''}`}
//                   onClick={() => {
...
//             className="flex-grow border-transparent focus:outline-none focus:ring-0 px-3 py-2 rounded w-full"
//           />
