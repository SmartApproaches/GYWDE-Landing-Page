  ...
  return (
    <>
      <div className=" max-w-6xl mx-auto my-15 flex flex-col lg:flex-row justify-between gap-2 bg-[var(--background-secondary)]] ">
        <div className=" text-center lg:text-start mx-4 md:mx-12 gap-10 ">
          <h1 className="uppercase text-[22.69px] lg:text-[40px] leading-[1.5] text-[var(--text-other)] font-semibold text-center lg:text-start ">
            _why choose us_
          </h1>
          <p className="font-bold text-[28.19px] mt-[22px] lg:text-[55px] text-[var(--primary)] lg:leading-[1.5]">
            Elevate your 
            <br className="hidden  lg:block" /> Service Experience
          </p>
        </div>
        <div className="cards flex flex-col lg:flex-row mx-10 gap-4 lg:gap-0 lg:-mr-15">
          {cards.map((card, key) => {
            ...
            return (
              <div
                key={key}
                className={`relative border border-1 lg:border-3 border-[var(--primary)] sm:mx-4 lg:mx-0 px-4 py-10 lg:py-20 mt-4 lg:mt-0 lg:px-5  rounded-3xl lg:rounded-[50px] 
                ${
                  isLast
              ...
              >
                ...
                <div className="text-center justify-center place-self-center mt-2 lg:mt-5 ">
                  <h1 className="text-xl lg:text-[32.06px] mt-5 text-[var(--secondary)] font-bold whitespace-nowrap text-center">
                    {card.title}
                  </h1>
