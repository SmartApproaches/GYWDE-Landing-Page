  ...
  return (
    <>
      <div className=" max-w-6xl mx-auto my-15 flex flex-col lg:flex-row justify-between gap-2 bg-[var(--background-secondary)]] ">
        <div className="mx-auto text-center md:text-start mx-4 md:mx-8  gap-10 ">
        ...
        <div className="cards flex flex-col lg:flex-row mx-4 gap-8 lg:gap-0 ">
          {cards.map((card, key) => {
            ...
            return (
              <div
                key={key}
                className={`relative border border-2 border-[var(--primary)] px-6 py-20 lg:px-4 lg:py-15 rounded-[50px] 
                ${
                  isLast
